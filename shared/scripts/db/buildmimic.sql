...
\copy ADMISSIONS FROM 'scripts/db/csv/ADMISSIONS.csv' DELIMITER ',' CSV HEADER NULL ''
...
\copy PATIENTS FROM 'scripts/db/csv/PATIENTS.csv' DELIMITER ',' CSV HEADER NULL ''
...
\copy DIAGNOSES_ICD FROM 'scripts/db/csv/DIAGNOSES_ICD.csv' DELIMITER ',' CSV HEADER NULL ''
...
\copy D_ICD_DIAGNOSES FROM 'scripts/db/csv/D_ICD_DIAGNOSES.csv' DELIMITER ',' CSV HEADER NULL ''
